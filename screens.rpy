...
screen music_room():
    ...
    if ost.game_soundtrack:
        ...
        hbox:
            ...
            imagebutton:
                idle ConditionSwitch("ost.organizeAZ", "images/music_room/A-ZOn.png", "True", "images/music_room/A-Z.png")
                action [ToggleVariable("ost.organizeAZ", False, True), Function(ost.resort)]
            
            imagebutton:
                idle ConditionSwitch("ost.organizePriority", "images/music_room/priorityOn.png", "True", "images/music_room/priority.png")
            ...
            imagebutton:
                ...
                action [ToggleVariable("ost.loopSong", False, True), Function(ost.current_music_play)]
        ...
        imagebutton:
            ...
            idle ConditionSwitch("preferences.get_volume(\"music_room_mixer\") == 0.0", "images/music_room/volume.png", "True", "images/music_room/volumeOn.png")
